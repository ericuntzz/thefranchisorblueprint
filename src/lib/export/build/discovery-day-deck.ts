 ...
 * Discovery Day.
 *
 * Customer can edit by re-drafting the underlying chapters; this builder
...
export function buildDiscoveryDayDeck(ctx: BuildContext): SlideDoc {
  ...
  return {
    ...
    disclaimer:
      "Generated by The Franchisor Blueprint. Edit by updating the underlying chapters; this deck regenerates from your live Memory.",
    slides,
  };
}

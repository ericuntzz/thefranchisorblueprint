...
Most franchise consulting content assumes franchising is your answer because that's what consultants sell. (For the legal definition of what counts as a franchise versus what doesn't, see the [FTC Franchise Rule glossary entry](/glossary/ftc-franchise-rule).) This is the post that breaks the bias. Here are the four real expansion paths, what each one is for, and the framework I use to help founders pick the right one.
...
International franchise expansion is often structured as joint ventures or [master franchise](/glossary/master-franchise) arrangements (a hybrid of franchise + JV). McDonald's used JVs heavily in its international expansion through the 1980s and 1990s.
